...
export const COMMAND_HELP = {
  ...
  */
  ...
  "fast": {
    ...
    description:
      "Toggle Opus 4.6 fast mode — 2.5x faster responses at higher per-token cost, same quality",
    usage: "/fast",
    examples: [
      "/fast",
    ],
  ...
  "claude-info": {
    ...
    parameters: [
      {
        name: "section",
        description: "Which info section to show (account, models, mcp, or all)",
        required: false,
      },
    ],
    notes: [
  ...
  "rewind": {
    ...
    parameters: [
      {
        name: "turn",
        description: "Turn number to rewind to (omit to see available turns)",
        required: false,
      },
  ...
  "claude-control": {
    ...
    description:
      "Control an active Claude query — interrupt, switch models, change permissions, or stop tasks",
    usage:
      "/claude-control action: [interrupt/set-model/set-permissions/stop-task/status] value: [optional]",
    examples: [
    ...
    parameters: [
      ...
      {
        name: "value",
        description: "Value for the action (model name, permission mode, or task ID)",
        required: false,
      },
    ],
    notes: [
          ...
          embeds: [{
            ...
            fields: [
              ...
              },
              {
                name: "⚙️ Settings",
                value:
                  "`/settings` - Unified settings hub (all categories)\n`/quick-model` - Quick model switch\n`/fast` - Toggle fast mode",
                inline: false,
              },
              {
                name: "📂 Git Commands",
